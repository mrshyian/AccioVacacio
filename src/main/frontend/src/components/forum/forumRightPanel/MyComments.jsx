        ...
        <div>
            ...
            <Card.Header style={{justifyContent: "space-between", color: "orange", display: "flex", backgroundColor: "rgb(35, 35, 35)"}}>
                ...
                <p style={{ marginBottom: -30 }}>
                    <Image fluid="true" className="imgForPost" src={myComments.commentImage} alt="user photo"/>
                    <p>{myComments.userName}</p></p>
                <p>{myComments.commentDateTime}</p>
                {/*<p>{props.user.role}</p>*/}
            </Card.Header>
            <Card.Body style={{ backgroundColor: "rgb(55, 55, 55)"}}>
                <Card.Text style={{color: "white"}}>
                    {myComments.commentText}
